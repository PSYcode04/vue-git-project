  ...
  <Container
    ...
    <Draggable class="bg-gray-200 dark:bg-gray-700 rounded-lg h-full w-96 flex-shrink-0 shadow-xl"
      ...
      <div class="h-full flex flex-col">
        ...
        <!-- header-->
        <div class="cursor-grab rounded-t-lg p-4 space-x-4 bg-primary text-white flex space-x-2">
        ...
        <Container
          ...
          @drop="(e) => onCardDrop(column.id, e)">
            ...
            <!-- Items -->
            <KanbanCard v-for="item in column.children" :key="item.id" :item="item"></KanbanCard>
        </Container>
      </div>
    </Draggable>
  </Container>
...
import { applyDrag, generateItems, generateWords } from '../utils/helper.js'
...
export default {
  ...
  methods: {
    async getLorem() {
      const result= await axios.get("http://digico-kanban.tk:9000/test/hello");
      console.log(result.data);
      this.lorem = result.data;
    },
    getColumnHeightPx(){
